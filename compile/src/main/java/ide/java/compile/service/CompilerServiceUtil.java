...
public class CompilerServiceUtil {
    ...
    private final TestCaseOutput testCaseOutput;

    private File SRC_FILE;
    private File STDIN_FILE;

    public CompilerServiceUtil(TestCaseInput testCaseInput) {
    ...
    private TestCaseOutput compile() {
        String text = "";
        try {
